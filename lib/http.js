...
OutgoingResponse.prototype.push = function push(options, priority) {
...
/*
  if (priority) {
     // pushStream.connection._reprioritize(pushStream, priority);
      //pushStream.emit('priority', priority);
      pushStream._priority = priority;
  }
*/
